...
export class AaveLinearPoolProtocolIdRegistered extends ethereum.Event {
  get params(): AaveLinearPoolProtocolIdRegistered__Params {
    return new AaveLinearPoolProtocolIdRegistered__Params(this);
  }
}

export class AaveLinearPoolProtocolIdRegistered__Params {
  _event: AaveLinearPoolProtocolIdRegistered;

  constructor(event: AaveLinearPoolProtocolIdRegistered) {
    this._event = event;
  }
...
export class AaveLinearPoolV3Factory__getCreationCodeContractsResult {
  value0: Address;
  value1: Address;
...
export class AaveLinearPoolV3Factory__getPauseConfigurationResult {
  value0: BigInt;
  value1: BigInt;
...
export class AaveLinearPoolV3Factory extends ethereum.SmartContract {
  static bind(address: Address): AaveLinearPoolV3Factory {
    return new AaveLinearPoolV3Factory("AaveLinearPoolV3Factory", address);
  }
  ...
  getCreationCodeContracts(): AaveLinearPoolV3Factory__getCreationCodeContractsResult {
    let result = super.call(
    ...
    return new AaveLinearPoolV3Factory__getCreationCodeContractsResult(
      result[0].toAddress(),
      result[1].toAddress(),
    );
  }

  try_getCreationCodeContracts(): ethereum.CallResult<AaveLinearPoolV3Factory__getCreationCodeContractsResult> {
    let result = super.tryCall(
      "getCreationCodeContracts",
      "getCreationCodeContracts():(address,address)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new AaveLinearPoolV3Factory__getCreationCodeContractsResult(
        value[0].toAddress(),
        value[1].toAddress(),
      ),
    );
  ...
  getPauseConfiguration(): AaveLinearPoolV3Factory__getPauseConfigurationResult {
    let result = super.call(
    ...
    return new AaveLinearPoolV3Factory__getPauseConfigurationResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_getPauseConfiguration(): ethereum.CallResult<AaveLinearPoolV3Factory__getPauseConfigurationResult> {
    let result = super.tryCall(
      "getPauseConfiguration",
      "getPauseConfiguration():(uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new AaveLinearPoolV3Factory__getPauseConfigurationResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
