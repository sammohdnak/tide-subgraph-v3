...
export class Gyro3Pool__capParamsResultValue0Struct extends ethereum.Tuple {
  get capEnabled(): boolean {
    return this[0].toBoolean();
  }
...
export class Gyro3Pool__getPausedStateResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class Gyro3Pool__onExitPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class Gyro3Pool__onJoinPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class Gyro3Pool__onSwapInputRequestStruct extends ethereum.Tuple {
  get kind(): i32 {
    return this[0].toI32();
  }
...
export class Gyro3Pool__queryExitResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class Gyro3Pool__queryJoinResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class Gyro3Pool extends ethereum.SmartContract {
  static bind(address: Address): Gyro3Pool {
    return new Gyro3Pool("Gyro3Pool", address);
  }
  ...
  capParams(): Gyro3Pool__capParamsResultValue0Struct {
    let result = super.call(
      "capParams",
    ...
    return changetype<Gyro3Pool__capParamsResultValue0Struct>(
      result[0].toTuple(),
    );
  }

  try_capParams(): ethereum.CallResult<Gyro3Pool__capParamsResultValue0Struct> {
    let result = super.tryCall(
      "capParams",
      "capParams():((bool,uint120,uint128))",
      [],
    ...
    return ethereum.CallResult.fromValue(
      changetype<Gyro3Pool__capParamsResultValue0Struct>(value[0].toTuple()),
    );
  }
  ...
  getPausedState(): Gyro3Pool__getPausedStateResult {
    let result = super.call(
      "getPausedState",
    ...
    return new Gyro3Pool__getPausedStateResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_getPausedState(): ethereum.CallResult<Gyro3Pool__getPausedStateResult> {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Gyro3Pool__getPausedStateResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),
  ...
  getRoot3Alpha(): BigInt {
    let result = super.call("getRoot3Alpha", "getRoot3Alpha():(uint256)", []);

    return result[0].toBigInt();
  }

  try_getRoot3Alpha(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getRoot3Alpha",
      "getRoot3Alpha():(uint256)",
      [],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  onExitPool(
    ...
    return new Gyro3Pool__onExitPoolResult(
  ...
  try_onExitPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<Gyro3Pool__onExitPoolResult> {
    let result = super.tryCall(
      "onExitPool",
      "onExitPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Gyro3Pool__onExitPoolResult(
  ...
  onJoinPool(
    ...
    return new Gyro3Pool__onJoinPoolResult(
      result[0].toBigIntArray(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_onJoinPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<Gyro3Pool__onJoinPoolResult> {
    let result = super.tryCall(
      "onJoinPool",
      "onJoinPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Gyro3Pool__onJoinPoolResult(
        value[0].toBigIntArray(),
        value[1].toBigIntArray(),
      ),
    );
  ...
  onSwap(
    request: Gyro3Pool__onSwapInputRequestStruct,
  ...
  queryExit(
    ...
    return new Gyro3Pool__queryExitResult(
      result[0].toBigInt(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_queryExit(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<Gyro3Pool__queryExitResult> {
    let result = super.tryCall(
      "queryExit",
      "queryExit(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Gyro3Pool__queryExitResult(
        value[0].toBigInt(),
        value[1].toBigIntArray(),
      ),
    );
  ...
  queryJoin(
    ...
    return new Gyro3Pool__queryJoinResult(
      result[0].toBigInt(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_queryJoin(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<Gyro3Pool__queryJoinResult> {
    let result = super.tryCall(
      "queryJoin",
      "queryJoin(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Gyro3Pool__queryJoinResult(
        value[0].toBigInt(),
        value[1].toBigIntArray(),
      ),
    );
...
export class ConstructorCallParamsStruct extends ethereum.Tuple {
  ...
  get config(): ConstructorCallParamsConfigStruct {
    return changetype<ConstructorCallParamsConfigStruct>(this[2].toTuple());
  }
...
export class ConstructorCallParamsConfigStruct extends ethereum.Tuple {
  get name(): string {
  ...
  get capParams(): ConstructorCallParamsConfigCapParamsStruct {
    return changetype<ConstructorCallParamsConfigCapParamsStruct>(
      this[7].toTuple(),
    );
  }
...
export class ConstructorCallParamsConfigCapParamsStruct extends ethereum.Tuple {
  get capEnabled(): boolean {
    return this[0].toBoolean();
  }
