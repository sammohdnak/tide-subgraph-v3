...
export class ERC4626LinearPoolFactory extends ethereum.SmartContract {
  ...
  try_getCreationCodeContracts(): ethereum.CallResult<ERC4626LinearPoolFactory__getCreationCodeContractsResult> {
    let result = super.tryCall(
      "getCreationCodeContracts",
      "getCreationCodeContracts():(address,address)",
      [],
  ...
  try_getPauseConfiguration(): ethereum.CallResult<ERC4626LinearPoolFactory__getPauseConfigurationResult> {
    let result = super.tryCall(
      "getPauseConfiguration",
      "getPauseConfiguration():(uint256,uint256)",
      [],
