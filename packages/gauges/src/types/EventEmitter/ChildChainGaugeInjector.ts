...
export class ChildChainGaugeInjector__checkUpkeepResult {
  value0: boolean;
  value1: Bytes;
...
export class ChildChainGaugeInjector__getAccountInfoResult {
  value0: BigInt;
  value1: boolean;
  value2: i32;
  value3: i32;
...
export class ChildChainGaugeInjector extends ethereum.SmartContract {
  static bind(address: Address): ChildChainGaugeInjector {
    return new ChildChainGaugeInjector("ChildChainGaugeInjector", address);
  }
  ...
  checkUpkeep(param0: Bytes): ChildChainGaugeInjector__checkUpkeepResult {
    let result = super.call("checkUpkeep", "checkUpkeep(bytes):(bool,bytes)", [
      ethereum.Value.fromBytes(param0)
    ]);

    return new ChildChainGaugeInjector__checkUpkeepResult(
      result[0].toBoolean(),
      result[1].toBytes()
    );
  }
  ...
  try_checkUpkeep(
    param0: Bytes
  ): ethereum.CallResult<ChildChainGaugeInjector__checkUpkeepResult> {
    let result = super.tryCall(
      "checkUpkeep",
    ...
    return ethereum.CallResult.fromValue(
      new ChildChainGaugeInjector__checkUpkeepResult(
        value[0].toBoolean(),
        value[1].toBytes()
      )
    );
  ...
  getAccountInfo(
  ...
  ): ChildChainGaugeInjector__getAccountInfoResult {
    let result = super.call(
      "getAccountInfo",
    ...
    return new ChildChainGaugeInjector__getAccountInfoResult(
      result[0].toBigInt(),
      result[1].toBoolean(),
      result[2].toI32(),
      result[3].toI32(),
  ...
  try_getAccountInfo(
    targetAddress: Address
  ): ethereum.CallResult<ChildChainGaugeInjector__getAccountInfoResult> {
    let result = super.tryCall(
      "getAccountInfo",
      "getAccountInfo(address):(uint256,bool,uint8,uint8,uint56)",
      [ethereum.Value.fromAddress(targetAddress)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ChildChainGaugeInjector__getAccountInfoResult(
        value[0].toBigInt(),
        value[1].toBoolean(),
        value[2].toI32(),
        value[3].toI32(),
