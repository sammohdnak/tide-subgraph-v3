...
export class Erc4626LinearPoolCreated extends ethereum.Event {
  get params(): Erc4626LinearPoolCreated__Params {
    return new Erc4626LinearPoolCreated__Params(this);
  }
}

export class Erc4626LinearPoolCreated__Params {
  _event: Erc4626LinearPoolCreated;

  constructor(event: Erc4626LinearPoolCreated) {
    this._event = event;
  }
...
export class ERC4626LinearPoolV4Factory__getCreationCodeContractsResult {
  value0: Address;
  value1: Address;
...
export class ERC4626LinearPoolV4Factory__getPauseConfigurationResult {
  value0: BigInt;
  value1: BigInt;
...
export class ERC4626LinearPoolV4Factory extends ethereum.SmartContract {
  static bind(address: Address): ERC4626LinearPoolV4Factory {
    return new ERC4626LinearPoolV4Factory(
  ...
  getCreationCodeContracts(): ERC4626LinearPoolV4Factory__getCreationCodeContractsResult {
    let result = super.call(
    ...
    return new ERC4626LinearPoolV4Factory__getCreationCodeContractsResult(
      result[0].toAddress(),
      result[1].toAddress(),
    );
  }

  try_getCreationCodeContracts(): ethereum.CallResult<ERC4626LinearPoolV4Factory__getCreationCodeContractsResult> {
    let result = super.tryCall(
      "getCreationCodeContracts",
      "getCreationCodeContracts():(address,address)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new ERC4626LinearPoolV4Factory__getCreationCodeContractsResult(
        value[0].toAddress(),
        value[1].toAddress(),
      ),
    );
  ...
  getPauseConfiguration(): ERC4626LinearPoolV4Factory__getPauseConfigurationResult {
    let result = super.call(
    ...
    return new ERC4626LinearPoolV4Factory__getPauseConfigurationResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_getPauseConfiguration(): ethereum.CallResult<ERC4626LinearPoolV4Factory__getPauseConfigurationResult> {
    let result = super.tryCall(
      "getPauseConfiguration",
      "getPauseConfiguration():(uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ERC4626LinearPoolV4Factory__getPauseConfigurationResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
