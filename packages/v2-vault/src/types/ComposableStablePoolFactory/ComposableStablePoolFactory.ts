...
export class ComposableStablePoolFactory__getCreationCodeContractsResult {
  value0: Address;
  value1: Address;
...
export class ComposableStablePoolFactory__getPauseConfigurationResult {
  value0: BigInt;
  value1: BigInt;
...
export class ComposableStablePoolFactory extends ethereum.SmartContract {
  static bind(address: Address): ComposableStablePoolFactory {
    return new ComposableStablePoolFactory(
  ...
  getCreationCodeContracts(): ComposableStablePoolFactory__getCreationCodeContractsResult {
    let result = super.call(
    ...
    return new ComposableStablePoolFactory__getCreationCodeContractsResult(
      result[0].toAddress(),
      result[1].toAddress(),
    );
  }

  try_getCreationCodeContracts(): ethereum.CallResult<ComposableStablePoolFactory__getCreationCodeContractsResult> {
    let result = super.tryCall(
      "getCreationCodeContracts",
      "getCreationCodeContracts():(address,address)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new ComposableStablePoolFactory__getCreationCodeContractsResult(
        value[0].toAddress(),
        value[1].toAddress(),
      ),
    );
  ...
  getPauseConfiguration(): ComposableStablePoolFactory__getPauseConfigurationResult {
    let result = super.call(
    ...
    return new ComposableStablePoolFactory__getPauseConfigurationResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_getPauseConfiguration(): ethereum.CallResult<ComposableStablePoolFactory__getPauseConfigurationResult> {
    let result = super.tryCall(
      "getPauseConfiguration",
      "getPauseConfiguration():(uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ComposableStablePoolFactory__getPauseConfigurationResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
