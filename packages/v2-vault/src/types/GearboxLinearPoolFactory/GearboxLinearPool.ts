...
export class GearboxLinearPool__getPausedStateResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class GearboxLinearPool__getTargetsResult {
  value0: BigInt;
  value1: BigInt;
...
export class GearboxLinearPool__onExitPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class GearboxLinearPool__onJoinPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class GearboxLinearPool__onSwapInputRequestStruct extends ethereum.Tuple {
  get kind(): i32 {
    return this[0].toI32();
  }
...
export class GearboxLinearPool__onSwap1InputRequestStruct extends ethereum.Tuple {
  get kind(): i32 {
    return this[0].toI32();
  }
...
export class GearboxLinearPool__queryExitResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class GearboxLinearPool__queryJoinResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class GearboxLinearPool extends ethereum.SmartContract {
  static bind(address: Address): GearboxLinearPool {
    return new GearboxLinearPool("GearboxLinearPool", address);
  }
  ...
  getPausedState(): GearboxLinearPool__getPausedStateResult {
    let result = super.call(
      "getPausedState",
    ...
    return new GearboxLinearPool__getPausedStateResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_getPausedState(): ethereum.CallResult<GearboxLinearPool__getPausedStateResult> {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new GearboxLinearPool__getPausedStateResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),
  ...
  getTargets(): GearboxLinearPool__getTargetsResult {
    let result = super.call("getTargets", "getTargets():(uint256,uint256)", []);

    return new GearboxLinearPool__getTargetsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_getTargets(): ethereum.CallResult<GearboxLinearPool__getTargetsResult> {
    let result = super.tryCall(
      "getTargets",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GearboxLinearPool__getTargetsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
  ...
  onExitPool(
    ...
    param5: BigInt,
    userData: Bytes,
  ): GearboxLinearPool__onExitPoolResult {
    let result = super.call(
      "onExitPool",
    ...
    return new GearboxLinearPool__onExitPoolResult(
  ...
  try_onExitPool(
    ...
    param5: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<GearboxLinearPool__onExitPoolResult> {
    let result = super.tryCall(
      "onExitPool",
      "onExitPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GearboxLinearPool__onExitPoolResult(
  ...
  onJoinPool(
    ...
    param5: BigInt,
    userData: Bytes,
  ): GearboxLinearPool__onJoinPoolResult {
    let result = super.call(
      "onJoinPool",
    ...
    return new GearboxLinearPool__onJoinPoolResult(
      result[0].toBigIntArray(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_onJoinPool(
    ...
    param5: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<GearboxLinearPool__onJoinPoolResult> {
    let result = super.tryCall(
      "onJoinPool",
      "onJoinPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GearboxLinearPool__onJoinPoolResult(
        value[0].toBigIntArray(),
        value[1].toBigIntArray(),
      ),
    );
  ...
  onSwap(
    request: GearboxLinearPool__onSwapInputRequestStruct,
    balances: Array<BigInt>,
    indexIn: BigInt,
    indexOut: BigInt,
  ): BigInt {
  ...
  onSwap1(
    request: GearboxLinearPool__onSwap1InputRequestStruct,
  ...
  queryExit(
    ...
    param5: BigInt,
    userData: Bytes,
  ): GearboxLinearPool__queryExitResult {
    let result = super.call(
      "queryExit",
    ...
    return new GearboxLinearPool__queryExitResult(
      result[0].toBigInt(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_queryExit(
    ...
    param5: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<GearboxLinearPool__queryExitResult> {
    let result = super.tryCall(
      "queryExit",
      "queryExit(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GearboxLinearPool__queryExitResult(
        value[0].toBigInt(),
        value[1].toBigIntArray(),
      ),
    );
  ...
  queryJoin(
    ...
    param5: BigInt,
    userData: Bytes,
  ): GearboxLinearPool__queryJoinResult {
    let result = super.call(
      "queryJoin",
    ...
    return new GearboxLinearPool__queryJoinResult(
      result[0].toBigInt(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_queryJoin(
    ...
    param5: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<GearboxLinearPool__queryJoinResult> {
    let result = super.tryCall(
      "queryJoin",
      "queryJoin(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GearboxLinearPool__queryJoinResult(
        value[0].toBigInt(),
        value[1].toBigIntArray(),
      ),
    );
