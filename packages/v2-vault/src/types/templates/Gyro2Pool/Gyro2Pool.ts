...
export class Gyro2Pool__capParamsResultValue0Struct extends ethereum.Tuple {
  get capEnabled(): boolean {
    return this[0].toBoolean();
  }
...
export class Gyro2Pool extends ethereum.SmartContract {
  ...
  capParams(): Gyro2Pool__capParamsResultValue0Struct {
    let result = super.call(
      "capParams",
    ...
    return changetype<Gyro2Pool__capParamsResultValue0Struct>(
      result[0].toTuple()
    );
  }

  try_capParams(): ethereum.CallResult<Gyro2Pool__capParamsResultValue0Struct> {
    let result = super.tryCall(
      "capParams",
      "capParams():((bool,uint120,uint128))",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<Gyro2Pool__capParamsResultValue0Struct>(value[0].toTuple())
    );
  }
