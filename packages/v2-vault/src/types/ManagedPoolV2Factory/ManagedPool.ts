...
export class ManagedPool__getCircuitBreakerStateResult {
  ...
  getReferenceWeight(): BigInt {
    return this.value1;
  }

  getLowerBound(): BigInt {
    return this.value2;
  }

  getUpperBound(): BigInt {
    return this.value3;
  }

  getLowerBptPriceBound(): BigInt {
    return this.value4;
  }

  getUpperBptPriceBound(): BigInt {
    return this.value5;
  }
}
...
export class ManagedPool__getGradualSwapFeeUpdateParamsResult {
  ...
  getStartSwapFeePercentage(): BigInt {
    return this.value2;
  }

  getEndSwapFeePercentage(): BigInt {
    return this.value3;
  }
}
...
export class ManagedPool__getManagementAumFeeParamsResult {
  ...
  getAumFeePercentage(): BigInt {
    return this.value0;
  }

  getLastCollectionTimestamp(): BigInt {
    return this.value1;
  }
}
...
export class ManagedPool extends ethereum.SmartContract {
  ...
  try_getGradualSwapFeeUpdateParams(): ethereum.CallResult<ManagedPool__getGradualSwapFeeUpdateParamsResult> {
    let result = super.tryCall(
      "getGradualSwapFeeUpdateParams",
      "getGradualSwapFeeUpdateParams():(uint256,uint256,uint256,uint256)",
      [],
  ...
  try_getGradualWeightUpdateParams(): ethereum.CallResult<ManagedPool__getGradualWeightUpdateParamsResult> {
    let result = super.tryCall(
      "getGradualWeightUpdateParams",
      "getGradualWeightUpdateParams():(uint256,uint256,uint256[],uint256[])",
      [],
  ...
  try_getManagementAumFeeParams(): ethereum.CallResult<ManagedPool__getManagementAumFeeParamsResult> {
    let result = super.tryCall(
      "getManagementAumFeeParams",
      "getManagementAumFeeParams():(uint256,uint256)",
      [],
