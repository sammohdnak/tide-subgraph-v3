...
export class YearnLinearPoolFactory extends ethereum.SmartContract {
  ...
  try_getCreationCodeContracts(): ethereum.CallResult<YearnLinearPoolFactory__getCreationCodeContractsResult> {
    let result = super.tryCall(
      "getCreationCodeContracts",
      "getCreationCodeContracts():(address,address)",
      [],
  ...
  try_getPauseConfiguration(): ethereum.CallResult<YearnLinearPoolFactory__getPauseConfigurationResult> {
    let result = super.tryCall(
      "getPauseConfiguration",
      "getPauseConfiguration():(uint256,uint256)",
      [],
