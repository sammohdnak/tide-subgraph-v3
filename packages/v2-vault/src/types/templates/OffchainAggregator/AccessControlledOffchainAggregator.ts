...
export class AccessControlledOffchainAggregator extends ethereum.SmartContract {
  ...
  try_getRoundData(
    _roundId: BigInt,
  ): ethereum.CallResult<AccessControlledOffchainAggregator__getRoundDataResult> {
    let result = super.tryCall(
      "getRoundData",
      "getRoundData(uint80):(uint80,int256,uint256,uint256,uint80)",
      [ethereum.Value.fromUnsignedBigInt(_roundId)],
  ...
  try_latestConfigDetails(): ethereum.CallResult<AccessControlledOffchainAggregator__latestConfigDetailsResult> {
    let result = super.tryCall(
      "latestConfigDetails",
      "latestConfigDetails():(uint32,uint32,bytes16)",
      [],
  ...
  try_latestRoundData(): ethereum.CallResult<AccessControlledOffchainAggregator__latestRoundDataResult> {
    let result = super.tryCall(
      "latestRoundData",
      "latestRoundData():(uint80,int256,uint256,uint256,uint80)",
      [],
  ...
  try_validatorConfig(): ethereum.CallResult<AccessControlledOffchainAggregator__validatorConfigResult> {
    let result = super.tryCall(
      "validatorConfig",
      "validatorConfig():(address,uint32)",
      [],
