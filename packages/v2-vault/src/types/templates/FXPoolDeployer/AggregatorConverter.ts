...
export class AggregatorConverter extends ethereum.SmartContract {
  ...
  try_latestRoundData(): ethereum.CallResult<AggregatorConverter__latestRoundDataResult> {
    let result = super.tryCall(
      "latestRoundData",
      "latestRoundData():(uint80,int256,uint256,uint256,uint80)",
      [],
  ...
  try_proposedLatestRoundData(): ethereum.CallResult<AggregatorConverter__proposedLatestRoundDataResult> {
    let result = super.tryCall(
      "proposedLatestRoundData",
      "proposedLatestRoundData():(uint80,int256,uint256,uint256,uint80)",
      [],
