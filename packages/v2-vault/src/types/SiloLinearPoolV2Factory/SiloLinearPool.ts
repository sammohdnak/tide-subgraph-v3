...
export class SiloLinearPool__getPausedStateResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class SiloLinearPool__getTargetsResult {
  value0: BigInt;
  value1: BigInt;
...
export class SiloLinearPool__onExitPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class SiloLinearPool__onJoinPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class SiloLinearPool__onSwapInputRequestStruct extends ethereum.Tuple {
  get kind(): i32 {
    return this[0].toI32();
  }
...
export class SiloLinearPool__onSwap1InputRequestStruct extends ethereum.Tuple {
  get kind(): i32 {
    return this[0].toI32();
  }
...
export class SiloLinearPool__queryExitResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class SiloLinearPool__queryJoinResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class SiloLinearPool extends ethereum.SmartContract {
  static bind(address: Address): SiloLinearPool {
    return new SiloLinearPool("SiloLinearPool", address);
  }
  ...
  getPausedState(): SiloLinearPool__getPausedStateResult {
    let result = super.call(
      "getPausedState",
    ...
    return new SiloLinearPool__getPausedStateResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_getPausedState(): ethereum.CallResult<SiloLinearPool__getPausedStateResult> {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new SiloLinearPool__getPausedStateResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),
  ...
  getTargets(): SiloLinearPool__getTargetsResult {
    let result = super.call("getTargets", "getTargets():(uint256,uint256)", []);

    return new SiloLinearPool__getTargetsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_getTargets(): ethereum.CallResult<SiloLinearPool__getTargetsResult> {
    let result = super.tryCall(
      "getTargets",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SiloLinearPool__getTargetsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
  ...
  onExitPool(
    ...
    param5: BigInt,
    userData: Bytes,
  ): SiloLinearPool__onExitPoolResult {
    let result = super.call(
      "onExitPool",
    ...
    return new SiloLinearPool__onExitPoolResult(
  ...
  try_onExitPool(
    ...
    param5: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<SiloLinearPool__onExitPoolResult> {
    let result = super.tryCall(
      "onExitPool",
      "onExitPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SiloLinearPool__onExitPoolResult(
  ...
  onJoinPool(
    ...
    param5: BigInt,
    userData: Bytes,
  ): SiloLinearPool__onJoinPoolResult {
    let result = super.call(
      "onJoinPool",
    ...
    return new SiloLinearPool__onJoinPoolResult(
      result[0].toBigIntArray(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_onJoinPool(
    ...
    param5: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<SiloLinearPool__onJoinPoolResult> {
    let result = super.tryCall(
      "onJoinPool",
      "onJoinPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SiloLinearPool__onJoinPoolResult(
        value[0].toBigIntArray(),
        value[1].toBigIntArray(),
      ),
    );
  ...
  onSwap(
    request: SiloLinearPool__onSwapInputRequestStruct,
    balances: Array<BigInt>,
    indexIn: BigInt,
    indexOut: BigInt,
  ): BigInt {
  ...
  onSwap1(
    request: SiloLinearPool__onSwap1InputRequestStruct,
  ...
  queryExit(
    ...
    param5: BigInt,
    userData: Bytes,
  ): SiloLinearPool__queryExitResult {
    let result = super.call(
      "queryExit",
    ...
    return new SiloLinearPool__queryExitResult(
      result[0].toBigInt(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_queryExit(
    ...
    param5: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<SiloLinearPool__queryExitResult> {
    let result = super.tryCall(
      "queryExit",
      "queryExit(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SiloLinearPool__queryExitResult(
        value[0].toBigInt(),
        value[1].toBigIntArray(),
      ),
    );
  ...
  queryJoin(
    ...
    param5: BigInt,
    userData: Bytes,
  ): SiloLinearPool__queryJoinResult {
    let result = super.call(
      "queryJoin",
    ...
    return new SiloLinearPool__queryJoinResult(
      result[0].toBigInt(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_queryJoin(
    ...
    param5: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<SiloLinearPool__queryJoinResult> {
    let result = super.tryCall(
      "queryJoin",
      "queryJoin(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SiloLinearPool__queryJoinResult(
        value[0].toBigInt(),
        value[1].toBigIntArray(),
      ),
    );
