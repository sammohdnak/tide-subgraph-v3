...
export class EulerLinearPoolCreated extends ethereum.Event {
  get params(): EulerLinearPoolCreated__Params {
    return new EulerLinearPoolCreated__Params(this);
  }
}

export class EulerLinearPoolCreated__Params {
  _event: EulerLinearPoolCreated;

  constructor(event: EulerLinearPoolCreated) {
    this._event = event;
  }
...
export class EulerLinearPoolFactory__getCreationCodeContractsResult {
  value0: Address;
  value1: Address;
...
export class EulerLinearPoolFactory__getPauseConfigurationResult {
  value0: BigInt;
  value1: BigInt;
...
export class EulerLinearPoolFactory extends ethereum.SmartContract {
  static bind(address: Address): EulerLinearPoolFactory {
    return new EulerLinearPoolFactory("EulerLinearPoolFactory", address);
  }
  ...
  eulerProtocol(): Address {
    let result = super.call("eulerProtocol", "eulerProtocol():(address)", []);

    return result[0].toAddress();
  }

  try_eulerProtocol(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "eulerProtocol",
      "eulerProtocol():(address)",
      [],
  ...
  getCreationCodeContracts(): EulerLinearPoolFactory__getCreationCodeContractsResult {
    let result = super.call(
    ...
    return new EulerLinearPoolFactory__getCreationCodeContractsResult(
      result[0].toAddress(),
      result[1].toAddress(),
    );
  }

  try_getCreationCodeContracts(): ethereum.CallResult<EulerLinearPoolFactory__getCreationCodeContractsResult> {
    let result = super.tryCall(
      "getCreationCodeContracts",
      "getCreationCodeContracts():(address,address)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new EulerLinearPoolFactory__getCreationCodeContractsResult(
        value[0].toAddress(),
        value[1].toAddress(),
      ),
    );
  ...
  getPauseConfiguration(): EulerLinearPoolFactory__getPauseConfigurationResult {
    let result = super.call(
    ...
    return new EulerLinearPoolFactory__getPauseConfigurationResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_getPauseConfiguration(): ethereum.CallResult<EulerLinearPoolFactory__getPauseConfigurationResult> {
    let result = super.tryCall(
      "getPauseConfiguration",
      "getPauseConfiguration():(uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new EulerLinearPoolFactory__getPauseConfigurationResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
