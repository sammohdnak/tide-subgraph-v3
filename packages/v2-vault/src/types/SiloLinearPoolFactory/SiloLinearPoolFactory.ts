...
export class SiloLinearPoolFactory__getCreationCodeContractsResult {
  value0: Address;
  value1: Address;
...
export class SiloLinearPoolFactory__getPauseConfigurationResult {
  value0: BigInt;
  value1: BigInt;
...
export class SiloLinearPoolFactory extends ethereum.SmartContract {
  static bind(address: Address): SiloLinearPoolFactory {
    return new SiloLinearPoolFactory("SiloLinearPoolFactory", address);
  }
  ...
  getCreationCodeContracts(): SiloLinearPoolFactory__getCreationCodeContractsResult {
    let result = super.call(
    ...
    return new SiloLinearPoolFactory__getCreationCodeContractsResult(
      result[0].toAddress(),
      result[1].toAddress(),
    );
  }

  try_getCreationCodeContracts(): ethereum.CallResult<SiloLinearPoolFactory__getCreationCodeContractsResult> {
    let result = super.tryCall(
      "getCreationCodeContracts",
      "getCreationCodeContracts():(address,address)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new SiloLinearPoolFactory__getCreationCodeContractsResult(
        value[0].toAddress(),
        value[1].toAddress(),
      ),
    );
  ...
  getPauseConfiguration(): SiloLinearPoolFactory__getPauseConfigurationResult {
    let result = super.call(
    ...
    return new SiloLinearPoolFactory__getPauseConfigurationResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_getPauseConfiguration(): ethereum.CallResult<SiloLinearPoolFactory__getPauseConfigurationResult> {
    let result = super.tryCall(
      "getPauseConfiguration",
      "getPauseConfiguration():(uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SiloLinearPoolFactory__getPauseConfigurationResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
