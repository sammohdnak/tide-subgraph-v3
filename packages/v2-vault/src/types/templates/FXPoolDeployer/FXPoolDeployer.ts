...
export class FXPoolDeployer__getFXPoolDetailsResult {
  ...
  getBaseOracle(): Address {
    return this.value2;
  }

  getProtocolPercentFee(): BigInt {
    return this.value3;
  }
...
export class FXPoolDeployer__newFXPoolResult {
  ...
  getBalancerPoolId(): Bytes {
    return this.value0;
  }

  getFxpoolAddr(): Address {
    return this.value1;
  }
}
...
export class FXPoolDeployer__poolsDataResult {
  ...
  getBaseAssimilatorTemplate(): Address {
    return this.value2;
  }
