...
export class InvestmentPoolFactory extends ethereum.SmartContract {
  ...
  try_getCreationCodeContracts(): ethereum.CallResult<InvestmentPoolFactory__getCreationCodeContractsResult> {
    let result = super.tryCall(
      "getCreationCodeContracts",
      "getCreationCodeContracts():(address,address)",
      [],
  ...
  try_getPauseConfiguration(): ethereum.CallResult<InvestmentPoolFactory__getPauseConfigurationResult> {
    let result = super.tryCall(
      "getPauseConfiguration",
      "getPauseConfiguration():(uint256,uint256)",
      [],
