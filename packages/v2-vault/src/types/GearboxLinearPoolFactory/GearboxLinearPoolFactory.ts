...
export class GearboxLinearPoolFactory__getCreationCodeContractsResult {
  value0: Address;
  value1: Address;
...
export class GearboxLinearPoolFactory__getPauseConfigurationResult {
  value0: BigInt;
  value1: BigInt;
...
export class GearboxLinearPoolFactory extends ethereum.SmartContract {
  static bind(address: Address): GearboxLinearPoolFactory {
    return new GearboxLinearPoolFactory("GearboxLinearPoolFactory", address);
  }
  ...
  getCreationCodeContracts(): GearboxLinearPoolFactory__getCreationCodeContractsResult {
    let result = super.call(
    ...
    return new GearboxLinearPoolFactory__getCreationCodeContractsResult(
      result[0].toAddress(),
      result[1].toAddress(),
    );
  }

  try_getCreationCodeContracts(): ethereum.CallResult<GearboxLinearPoolFactory__getCreationCodeContractsResult> {
    let result = super.tryCall(
      "getCreationCodeContracts",
      "getCreationCodeContracts():(address,address)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new GearboxLinearPoolFactory__getCreationCodeContractsResult(
        value[0].toAddress(),
        value[1].toAddress(),
      ),
    );
  ...
  getPauseConfiguration(): GearboxLinearPoolFactory__getPauseConfigurationResult {
    let result = super.call(
    ...
    return new GearboxLinearPoolFactory__getPauseConfigurationResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_getPauseConfiguration(): ethereum.CallResult<GearboxLinearPoolFactory__getPauseConfigurationResult> {
    let result = super.tryCall(
      "getPauseConfiguration",
      "getPauseConfiguration():(uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GearboxLinearPoolFactory__getPauseConfigurationResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
