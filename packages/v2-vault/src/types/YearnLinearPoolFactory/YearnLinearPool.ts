...
export class YearnLinearPool__getPausedStateResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class YearnLinearPool__getTargetsResult {
  value0: BigInt;
  value1: BigInt;
...
export class YearnLinearPool__onExitPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class YearnLinearPool__onJoinPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class YearnLinearPool__onSwapInputRequestStruct extends ethereum.Tuple {
  get kind(): i32 {
    return this[0].toI32();
  }
...
export class YearnLinearPool__onSwap1InputRequestStruct extends ethereum.Tuple {
  get kind(): i32 {
    return this[0].toI32();
  }
...
export class YearnLinearPool__queryExitResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class YearnLinearPool__queryJoinResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class YearnLinearPool extends ethereum.SmartContract {
  static bind(address: Address): YearnLinearPool {
    return new YearnLinearPool("YearnLinearPool", address);
  }
  ...
  getPausedState(): YearnLinearPool__getPausedStateResult {
    let result = super.call(
      "getPausedState",
    ...
    return new YearnLinearPool__getPausedStateResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_getPausedState(): ethereum.CallResult<YearnLinearPool__getPausedStateResult> {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new YearnLinearPool__getPausedStateResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),
  ...
  getTargets(): YearnLinearPool__getTargetsResult {
    let result = super.call("getTargets", "getTargets():(uint256,uint256)", []);

    return new YearnLinearPool__getTargetsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_getTargets(): ethereum.CallResult<YearnLinearPool__getTargetsResult> {
    let result = super.tryCall(
      "getTargets",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new YearnLinearPool__getTargetsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
  ...
  onExitPool(
    ...
    param5: BigInt,
    userData: Bytes,
  ): YearnLinearPool__onExitPoolResult {
    let result = super.call(
      "onExitPool",
    ...
    return new YearnLinearPool__onExitPoolResult(
  ...
  try_onExitPool(
    ...
    param5: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<YearnLinearPool__onExitPoolResult> {
    let result = super.tryCall(
      "onExitPool",
      "onExitPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new YearnLinearPool__onExitPoolResult(
  ...
  onJoinPool(
    ...
    param5: BigInt,
    userData: Bytes,
  ): YearnLinearPool__onJoinPoolResult {
    let result = super.call(
      "onJoinPool",
    ...
    return new YearnLinearPool__onJoinPoolResult(
      result[0].toBigIntArray(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_onJoinPool(
    ...
    param5: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<YearnLinearPool__onJoinPoolResult> {
    let result = super.tryCall(
      "onJoinPool",
      "onJoinPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new YearnLinearPool__onJoinPoolResult(
        value[0].toBigIntArray(),
        value[1].toBigIntArray(),
      ),
    );
  ...
  onSwap(
    request: YearnLinearPool__onSwapInputRequestStruct,
    balances: Array<BigInt>,
    indexIn: BigInt,
    indexOut: BigInt,
  ): BigInt {
  ...
  onSwap1(
    request: YearnLinearPool__onSwap1InputRequestStruct,
  ...
  queryExit(
    ...
    param5: BigInt,
    userData: Bytes,
  ): YearnLinearPool__queryExitResult {
    let result = super.call(
      "queryExit",
    ...
    return new YearnLinearPool__queryExitResult(
      result[0].toBigInt(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_queryExit(
    ...
    param5: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<YearnLinearPool__queryExitResult> {
    let result = super.tryCall(
      "queryExit",
      "queryExit(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new YearnLinearPool__queryExitResult(
        value[0].toBigInt(),
        value[1].toBigIntArray(),
      ),
    );
  ...
  queryJoin(
    ...
    param5: BigInt,
    userData: Bytes,
  ): YearnLinearPool__queryJoinResult {
    let result = super.call(
      "queryJoin",
    ...
    return new YearnLinearPool__queryJoinResult(
      result[0].toBigInt(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_queryJoin(
    ...
    param5: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<YearnLinearPool__queryJoinResult> {
    let result = super.tryCall(
      "queryJoin",
      "queryJoin(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new YearnLinearPool__queryJoinResult(
        value[0].toBigInt(),
        value[1].toBigIntArray(),
      ),
    );
