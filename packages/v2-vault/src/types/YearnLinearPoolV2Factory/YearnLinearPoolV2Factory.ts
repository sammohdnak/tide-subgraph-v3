...
export class YearnLinearPoolV2Factory__getCreationCodeContractsResult {
  value0: Address;
  value1: Address;
...
export class YearnLinearPoolV2Factory__getPauseConfigurationResult {
  value0: BigInt;
  value1: BigInt;
...
export class YearnLinearPoolV2Factory extends ethereum.SmartContract {
  static bind(address: Address): YearnLinearPoolV2Factory {
    return new YearnLinearPoolV2Factory("YearnLinearPoolV2Factory", address);
  }
  ...
  getCreationCodeContracts(): YearnLinearPoolV2Factory__getCreationCodeContractsResult {
    let result = super.call(
    ...
    return new YearnLinearPoolV2Factory__getCreationCodeContractsResult(
      result[0].toAddress(),
      result[1].toAddress(),
    );
  }

  try_getCreationCodeContracts(): ethereum.CallResult<YearnLinearPoolV2Factory__getCreationCodeContractsResult> {
    let result = super.tryCall(
      "getCreationCodeContracts",
      "getCreationCodeContracts():(address,address)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new YearnLinearPoolV2Factory__getCreationCodeContractsResult(
        value[0].toAddress(),
        value[1].toAddress(),
      ),
    );
  ...
  getPauseConfiguration(): YearnLinearPoolV2Factory__getPauseConfigurationResult {
    let result = super.call(
    ...
    return new YearnLinearPoolV2Factory__getPauseConfigurationResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_getPauseConfiguration(): ethereum.CallResult<YearnLinearPoolV2Factory__getPauseConfigurationResult> {
    let result = super.tryCall(
      "getPauseConfiguration",
      "getPauseConfiguration():(uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new YearnLinearPoolV2Factory__getPauseConfigurationResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
