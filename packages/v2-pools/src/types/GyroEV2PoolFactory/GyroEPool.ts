...
export class GyroEPool__getECLPParamsResult {
  ...
  getParams(): GyroEPool__getECLPParamsResultParamsStruct {
    return this.value0;
  }

  getD(): GyroEPool__getECLPParamsResultDStruct {
    return this.value1;
  }
}
...
export class GyroEPool__getTokenRatesResult {
  value0: BigInt;
  value1: BigInt;
...
export class GyroEPool extends ethereum.SmartContract {
  ...
  getTokenRates(): GyroEPool__getTokenRatesResult {
    let result = super.call(
      "getTokenRates",
    ...
    return new GyroEPool__getTokenRatesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_getTokenRates(): ethereum.CallResult<GyroEPool__getTokenRatesResult> {
    let result = super.tryCall(
      "getTokenRates",
      "getTokenRates():(uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GyroEPool__getTokenRatesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
