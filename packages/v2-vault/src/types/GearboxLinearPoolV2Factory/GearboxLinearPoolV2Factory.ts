...
export class GearboxLinearPoolCreated extends ethereum.Event {
  get params(): GearboxLinearPoolCreated__Params {
    return new GearboxLinearPoolCreated__Params(this);
  }
}

export class GearboxLinearPoolCreated__Params {
  _event: GearboxLinearPoolCreated;

  constructor(event: GearboxLinearPoolCreated) {
    this._event = event;
  }
...
export class GearboxLinearPoolV2Factory__getCreationCodeContractsResult {
  value0: Address;
  value1: Address;
...
export class GearboxLinearPoolV2Factory__getPauseConfigurationResult {
  value0: BigInt;
  value1: BigInt;
...
export class GearboxLinearPoolV2Factory extends ethereum.SmartContract {
  static bind(address: Address): GearboxLinearPoolV2Factory {
    return new GearboxLinearPoolV2Factory(
  ...
  create(
    ...
    let result = super.call(
      "create",
      "create(string,string,address,address,uint256,uint256,address,uint256,bytes32):(address)",
      [
  ...
  getCreationCodeContracts(): GearboxLinearPoolV2Factory__getCreationCodeContractsResult {
    let result = super.call(
    ...
    return new GearboxLinearPoolV2Factory__getCreationCodeContractsResult(
      result[0].toAddress(),
      result[1].toAddress(),
    );
  }

  try_getCreationCodeContracts(): ethereum.CallResult<GearboxLinearPoolV2Factory__getCreationCodeContractsResult> {
    let result = super.tryCall(
      "getCreationCodeContracts",
      "getCreationCodeContracts():(address,address)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new GearboxLinearPoolV2Factory__getCreationCodeContractsResult(
        value[0].toAddress(),
        value[1].toAddress(),
      ),
    );
  ...
  getPauseConfiguration(): GearboxLinearPoolV2Factory__getPauseConfigurationResult {
    let result = super.call(
    ...
    return new GearboxLinearPoolV2Factory__getPauseConfigurationResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_getPauseConfiguration(): ethereum.CallResult<GearboxLinearPoolV2Factory__getPauseConfigurationResult> {
    let result = super.tryCall(
      "getPauseConfiguration",
      "getPauseConfiguration():(uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GearboxLinearPoolV2Factory__getPauseConfigurationResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
