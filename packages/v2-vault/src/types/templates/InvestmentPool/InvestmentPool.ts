...
export class ManagementFeePercentageChanged extends ethereum.Event {
  get params(): ManagementFeePercentageChanged__Params {
    return new ManagementFeePercentageChanged__Params(this);
  }
}

export class ManagementFeePercentageChanged__Params {
  _event: ManagementFeePercentageChanged;

  constructor(event: ManagementFeePercentageChanged) {
    this._event = event;
  }

  get managementFeePercentage(): BigInt {
    return this._event.parameters[0].value.toBigInt();
  }
}

export class ManagementFeesCollected extends ethereum.Event {
  get params(): ManagementFeesCollected__Params {
    return new ManagementFeesCollected__Params(this);
  }
}

export class ManagementFeesCollected__Params {
...
export class InvestmentPool__getCollectedManagementFeesResult {
  ...
  getCollectedFees(): Array<BigInt> {
    return this.value1;
  }
}

export class InvestmentPool__getGradualWeightUpdateParamsResult {
  value0: BigInt;
  value1: BigInt;
  value2: Array<BigInt>;
  ...
  getEndWeights(): Array<BigInt> {
    return this.value2;
  }
}

export class InvestmentPool__getPausedStateResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class InvestmentPool__onExitPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class InvestmentPool__onJoinPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class InvestmentPool__onSwapInputSwapRequestStruct extends ethereum.Tuple {
  get kind(): i32 {
    return this[0].toI32();
  }
...
export class InvestmentPool__queryExitResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class InvestmentPool__queryJoinResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class InvestmentPool extends ethereum.SmartContract {
  ...
  getCollectedManagementFees(): InvestmentPool__getCollectedManagementFeesResult {
    let result = super.call(
      "getCollectedManagementFees",
      "getCollectedManagementFees():(address[],uint256[])",
      [],
    );

    return new InvestmentPool__getCollectedManagementFeesResult(
      result[0].toAddressArray(),
      result[1].toBigIntArray(),
    );
  }

  try_getCollectedManagementFees(): ethereum.CallResult<InvestmentPool__getCollectedManagementFeesResult> {
    let result = super.tryCall(
      "getCollectedManagementFees",
      "getCollectedManagementFees():(address[],uint256[])",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new InvestmentPool__getCollectedManagementFeesResult(
  ...
  getGradualWeightUpdateParams(): InvestmentPool__getGradualWeightUpdateParamsResult {
    let result = super.call(
      "getGradualWeightUpdateParams",
      "getGradualWeightUpdateParams():(uint256,uint256,uint256[])",
      [],
    );

    return new InvestmentPool__getGradualWeightUpdateParamsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
  ...
  try_getGradualWeightUpdateParams(): ethereum.CallResult<InvestmentPool__getGradualWeightUpdateParamsResult> {
    let result = super.tryCall(
      "getGradualWeightUpdateParams",
      "getGradualWeightUpdateParams():(uint256,uint256,uint256[])",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new InvestmentPool__getGradualWeightUpdateParamsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
  ...
  getManagementSwapFeePercentage(): BigInt {
    let result = super.call(
      "getManagementSwapFeePercentage",
      "getManagementSwapFeePercentage():(uint256)",
      [],
    );
  ...
  try_getManagementSwapFeePercentage(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getManagementSwapFeePercentage",
      "getManagementSwapFeePercentage():(uint256)",
      [],
  ...
  getMinimumWeightChangeDuration(): BigInt {
    let result = super.call(
      "getMinimumWeightChangeDuration",
      "getMinimumWeightChangeDuration():(uint256)",
      [],
    );
  ...
  try_getMinimumWeightChangeDuration(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getMinimumWeightChangeDuration",
      "getMinimumWeightChangeDuration():(uint256)",
      [],
  ...
  getPausedState(): InvestmentPool__getPausedStateResult {
    let result = super.call(
      "getPausedState",
    ...
    return new InvestmentPool__getPausedStateResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_getPausedState(): ethereum.CallResult<InvestmentPool__getPausedStateResult> {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new InvestmentPool__getPausedStateResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),
  ...
  onExitPool(
    ...
    userData: Bytes,
  ): InvestmentPool__onExitPoolResult {
    let result = super.call(
      "onExitPool",
    ...
    return new InvestmentPool__onExitPoolResult(
  ...
  try_onExitPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<InvestmentPool__onExitPoolResult> {
    let result = super.tryCall(
      "onExitPool",
      "onExitPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new InvestmentPool__onExitPoolResult(
  ...
  onJoinPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): InvestmentPool__onJoinPoolResult {
    let result = super.call(
      "onJoinPool",
    ...
    return new InvestmentPool__onJoinPoolResult(
      result[0].toBigIntArray(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_onJoinPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<InvestmentPool__onJoinPoolResult> {
    let result = super.tryCall(
      "onJoinPool",
      "onJoinPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new InvestmentPool__onJoinPoolResult(
        value[0].toBigIntArray(),
        value[1].toBigIntArray(),
      ),
    );
  ...
  queryExit(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): InvestmentPool__queryExitResult {
    let result = super.call(
      "queryExit",
    ...
    return new InvestmentPool__queryExitResult(
      result[0].toBigInt(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_queryExit(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<InvestmentPool__queryExitResult> {
    let result = super.tryCall(
      "queryExit",
      "queryExit(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new InvestmentPool__queryExitResult(
        value[0].toBigInt(),
        value[1].toBigIntArray(),
      ),
    );
  ...
  queryJoin(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): InvestmentPool__queryJoinResult {
    let result = super.call(
      "queryJoin",
    ...
    return new InvestmentPool__queryJoinResult(
      result[0].toBigInt(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_queryJoin(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<InvestmentPool__queryJoinResult> {
    let result = super.tryCall(
      "queryJoin",
      "queryJoin(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new InvestmentPool__queryJoinResult(
        value[0].toBigInt(),
        value[1].toBigIntArray(),
      ),
    );
...
export class WithdrawCollectedManagementFeesCall extends ethereum.Call {
  get inputs(): WithdrawCollectedManagementFeesCall__Inputs {
    return new WithdrawCollectedManagementFeesCall__Inputs(this);
  }

  get outputs(): WithdrawCollectedManagementFeesCall__Outputs {
    return new WithdrawCollectedManagementFeesCall__Outputs(this);
  }
}

export class WithdrawCollectedManagementFeesCall__Inputs {
  _call: WithdrawCollectedManagementFeesCall;

  constructor(call: WithdrawCollectedManagementFeesCall) {
    this._call = call;
  }
...
export class WithdrawCollectedManagementFeesCall__Outputs {
  _call: WithdrawCollectedManagementFeesCall;
