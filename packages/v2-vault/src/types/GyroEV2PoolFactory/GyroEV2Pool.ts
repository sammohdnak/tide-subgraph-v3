...
export class GyroEV2Pool__capParamsResultValue0Struct extends ethereum.Tuple {
  get capEnabled(): boolean {
    return this[0].toBoolean();
  }
...
export class GyroEV2Pool__getECLPParamsResultParamsStruct extends ethereum.Tuple {
  get alpha(): BigInt {
    return this[0].toBigInt();
  }
...
export class GyroEV2Pool__getECLPParamsResultDStruct extends ethereum.Tuple {
  get tauAlpha(): GyroEV2Pool__getECLPParamsResultDTauAlphaStruct {
    return changetype<GyroEV2Pool__getECLPParamsResultDTauAlphaStruct>(
      this[0].toTuple(),
    );
  }

  get tauBeta(): GyroEV2Pool__getECLPParamsResultDTauBetaStruct {
    return changetype<GyroEV2Pool__getECLPParamsResultDTauBetaStruct>(
      this[1].toTuple(),
    );
  }
...
export class GyroEV2Pool__getECLPParamsResultDTauAlphaStruct extends ethereum.Tuple {
  get x(): BigInt {
    return this[0].toBigInt();
  }
...
export class GyroEV2Pool__getECLPParamsResultDTauBetaStruct extends ethereum.Tuple {
  get x(): BigInt {
    return this[0].toBigInt();
  }
...
export class GyroEV2Pool__getECLPParamsResult {
  value0: GyroEV2Pool__getECLPParamsResultParamsStruct;
  value1: GyroEV2Pool__getECLPParamsResultDStruct;
  ...
  getParams(): GyroEV2Pool__getECLPParamsResultParamsStruct {
    return this.value0;
  }

  getD(): GyroEV2Pool__getECLPParamsResultDStruct {
    return this.value1;
  }
}

export class GyroEV2Pool__getMiscDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class GyroEV2Pool__getPastAccumulatorsInputQueriesStruct extends ethereum.Tuple {
  get variable(): i32 {
    return this[0].toI32();
  }
...
export class GyroEV2Pool__getPausedStateResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class GyroEV2Pool__getSampleResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class GyroEV2Pool__getTimeWeightedAverageInputQueriesStruct extends ethereum.Tuple {
  get variable(): i32 {
    return this[0].toI32();
  }
...
export class GyroEV2Pool__getTokenRatesResult {
  value0: BigInt;
  value1: BigInt;
...
export class GyroEV2Pool__onExitPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class GyroEV2Pool__onJoinPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class GyroEV2Pool__onSwapInputRequestStruct extends ethereum.Tuple {
  get kind(): i32 {
    return this[0].toI32();
  }
...
export class GyroEV2Pool__queryExitResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class GyroEV2Pool__queryJoinResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class GyroEV2Pool extends ethereum.SmartContract {
  static bind(address: Address): GyroEV2Pool {
    return new GyroEV2Pool("GyroEV2Pool", address);
  }
  ...
  capParams(): GyroEV2Pool__capParamsResultValue0Struct {
    let result = super.call(
      "capParams",
    ...
    return changetype<GyroEV2Pool__capParamsResultValue0Struct>(
      result[0].toTuple(),
    );
  }

  try_capParams(): ethereum.CallResult<GyroEV2Pool__capParamsResultValue0Struct> {
    let result = super.tryCall(
      "capParams",
      "capParams():((bool,uint120,uint128))",
      [],
    ...
    return ethereum.CallResult.fromValue(
      changetype<GyroEV2Pool__capParamsResultValue0Struct>(value[0].toTuple()),
    );
  }
  ...
  getECLPParams(): GyroEV2Pool__getECLPParamsResult {
    let result = super.call(
      "getECLPParams",
    ...
    return changetype<GyroEV2Pool__getECLPParamsResult>(
      new GyroEV2Pool__getECLPParamsResult(
        changetype<GyroEV2Pool__getECLPParamsResultParamsStruct>(
          result[0].toTuple(),
        ),
        changetype<GyroEV2Pool__getECLPParamsResultDStruct>(
          result[1].toTuple(),
        ),
      ),
    );
  ...
  try_getECLPParams(): ethereum.CallResult<GyroEV2Pool__getECLPParamsResult> {
    let result = super.tryCall(
      "getECLPParams",
      "getECLPParams():((int256,int256,int256,int256,int256),((int256,int256),(int256,int256),int256,int256,int256,int256,int256))",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<GyroEV2Pool__getECLPParamsResult>(
        new GyroEV2Pool__getECLPParamsResult(
          changetype<GyroEV2Pool__getECLPParamsResultParamsStruct>(
            value[0].toTuple(),
          ),
  ...
  getMiscData(): GyroEV2Pool__getMiscDataResult {
    let result = super.call(
      "getMiscData",
    ...
    return new GyroEV2Pool__getMiscDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getMiscData(): ethereum.CallResult<GyroEV2Pool__getMiscDataResult> {
    let result = super.tryCall(
      "getMiscData",
      "getMiscData():(int256,int256,uint256,uint256,bool,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GyroEV2Pool__getMiscDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getPastAccumulators(
    queries: Array<GyroEV2Pool__getPastAccumulatorsInputQueriesStruct>,
  ): Array<BigInt> {
    let result = super.call(
      "getPastAccumulators",
  ...
  getPausedState(): GyroEV2Pool__getPausedStateResult {
    let result = super.call(
      "getPausedState",
    ...
    return new GyroEV2Pool__getPausedStateResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_getPausedState(): ethereum.CallResult<GyroEV2Pool__getPausedStateResult> {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GyroEV2Pool__getPausedStateResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),
  ...
  getSample(index: BigInt): GyroEV2Pool__getSampleResult {
    let result = super.call(
      "getSample",
    ...
    return new GyroEV2Pool__getSampleResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getSample(
    index: BigInt,
  ): ethereum.CallResult<GyroEV2Pool__getSampleResult> {
    let result = super.tryCall(
      "getSample",
      "getSample(uint256):(int256,int256,int256,int256,int256,int256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(index)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GyroEV2Pool__getSampleResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getTimeWeightedAverage(
    queries: Array<GyroEV2Pool__getTimeWeightedAverageInputQueriesStruct>,
  ): Array<BigInt> {
    let result = super.call(
      "getTimeWeightedAverage",
  ...
  getTokenRates(): GyroEV2Pool__getTokenRatesResult {
    let result = super.call(
      "getTokenRates",
      "getTokenRates():(uint256,uint256)",
      [],
    );

    return new GyroEV2Pool__getTokenRatesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_getTokenRates(): ethereum.CallResult<GyroEV2Pool__getTokenRatesResult> {
    let result = super.tryCall(
      "getTokenRates",
      "getTokenRates():(uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GyroEV2Pool__getTokenRatesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
  ...
  onExitPool(
    ...
    return new GyroEV2Pool__onExitPoolResult(
  ...
  try_onExitPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<GyroEV2Pool__onExitPoolResult> {
    let result = super.tryCall(
      "onExitPool",
      "onExitPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GyroEV2Pool__onExitPoolResult(
  ...
  onJoinPool(
    ...
    return new GyroEV2Pool__onJoinPoolResult(
      result[0].toBigIntArray(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_onJoinPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<GyroEV2Pool__onJoinPoolResult> {
    let result = super.tryCall(
      "onJoinPool",
      "onJoinPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GyroEV2Pool__onJoinPoolResult(
        value[0].toBigIntArray(),
        value[1].toBigIntArray(),
      ),
    );
  ...
  onSwap(
    request: GyroEV2Pool__onSwapInputRequestStruct,
  ...
  queryExit(
    ...
    return new GyroEV2Pool__queryExitResult(
      result[0].toBigInt(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_queryExit(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<GyroEV2Pool__queryExitResult> {
    let result = super.tryCall(
      "queryExit",
      "queryExit(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GyroEV2Pool__queryExitResult(
        value[0].toBigInt(),
        value[1].toBigIntArray(),
      ),
    );
  ...
  queryJoin(
    ...
    return new GyroEV2Pool__queryJoinResult(
      result[0].toBigInt(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_queryJoin(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<GyroEV2Pool__queryJoinResult> {
    let result = super.tryCall(
      "queryJoin",
      "queryJoin(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GyroEV2Pool__queryJoinResult(
        value[0].toBigInt(),
        value[1].toBigIntArray(),
      ),
    );
  ...
  rateProvider0(): Address {
    let result = super.call("rateProvider0", "rateProvider0():(address)", []);

    return result[0].toAddress();
  }

  try_rateProvider0(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "rateProvider0",
      "rateProvider0():(address)",
      [],
  ...
  rateProvider1(): Address {
    let result = super.call("rateProvider1", "rateProvider1():(address)", []);

    return result[0].toAddress();
  }

  try_rateProvider1(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "rateProvider1",
      "rateProvider1():(address)",
      [],
...
export class ConstructorCallParamsStruct extends ethereum.Tuple {
  ...
  get rateProvider0(): Address {
    return this[3].toAddress();
  }

  get rateProvider1(): Address {
  ...
  get capParams(): ConstructorCallParamsCapParamsStruct {
    return changetype<ConstructorCallParamsCapParamsStruct>(this[6].toTuple());
  }
