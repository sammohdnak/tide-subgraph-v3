...
export class ComposableStablePool__getLastJoinExitDataResult {
  ...
  getLastJoinExitAmplification(): BigInt {
    return this.value0;
  }
...
export class ComposableStablePool extends ethereum.SmartContract {
  ...
  try_getAmplificationParameter(): ethereum.CallResult<ComposableStablePool__getAmplificationParameterResult> {
    let result = super.tryCall(
      "getAmplificationParameter",
      "getAmplificationParameter():(uint256,bool,uint256)",
      [],
  ...
  try_getLastJoinExitData(): ethereum.CallResult<ComposableStablePool__getLastJoinExitDataResult> {
    let result = super.tryCall(
      "getLastJoinExitData",
      "getLastJoinExitData():(uint256,uint256)",
      [],
  ...
  try_getPausedState(): ethereum.CallResult<ComposableStablePool__getPausedStateResult> {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
      [],
