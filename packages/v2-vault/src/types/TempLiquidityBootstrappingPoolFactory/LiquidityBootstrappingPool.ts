...
export class LiquidityBootstrappingPool__getGradualWeightUpdateParamsResult {
  value0: BigInt;
  value1: BigInt;
  value2: Array<BigInt>;
...
export class LiquidityBootstrappingPool__getPausedStateResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class LiquidityBootstrappingPool__onExitPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class LiquidityBootstrappingPool__onJoinPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class LiquidityBootstrappingPool__onSwapInputRequestStruct extends ethereum.Tuple {
  get kind(): i32 {
    return this[0].toI32();
  }
...
export class LiquidityBootstrappingPool__queryExitResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class LiquidityBootstrappingPool__queryJoinResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class LiquidityBootstrappingPool extends ethereum.SmartContract {
  static bind(address: Address): LiquidityBootstrappingPool {
  ...
  getGradualWeightUpdateParams(): LiquidityBootstrappingPool__getGradualWeightUpdateParamsResult {
    let result = super.call(
    ...
    return new LiquidityBootstrappingPool__getGradualWeightUpdateParamsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
  ...
  try_getGradualWeightUpdateParams(): ethereum.CallResult<LiquidityBootstrappingPool__getGradualWeightUpdateParamsResult> {
    let result = super.tryCall(
      "getGradualWeightUpdateParams",
      "getGradualWeightUpdateParams():(uint256,uint256,uint256[])",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new LiquidityBootstrappingPool__getGradualWeightUpdateParamsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
  ...
  getPausedState(): LiquidityBootstrappingPool__getPausedStateResult {
    let result = super.call(
      "getPausedState",
    ...
    return new LiquidityBootstrappingPool__getPausedStateResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_getPausedState(): ethereum.CallResult<LiquidityBootstrappingPool__getPausedStateResult> {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new LiquidityBootstrappingPool__getPausedStateResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),
  ...
  onExitPool(
    ...
    userData: Bytes,
  ): LiquidityBootstrappingPool__onExitPoolResult {
    let result = super.call(
      "onExitPool",
    ...
    return new LiquidityBootstrappingPool__onExitPoolResult(
  ...
  try_onExitPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<LiquidityBootstrappingPool__onExitPoolResult> {
    let result = super.tryCall(
      "onExitPool",
      "onExitPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new LiquidityBootstrappingPool__onExitPoolResult(
  ...
  onJoinPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): LiquidityBootstrappingPool__onJoinPoolResult {
    let result = super.call(
      "onJoinPool",
    ...
    return new LiquidityBootstrappingPool__onJoinPoolResult(
      result[0].toBigIntArray(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_onJoinPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<LiquidityBootstrappingPool__onJoinPoolResult> {
    let result = super.tryCall(
      "onJoinPool",
      "onJoinPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new LiquidityBootstrappingPool__onJoinPoolResult(
        value[0].toBigIntArray(),
        value[1].toBigIntArray(),
      ),
    );
  ...
  onSwap(
    request: LiquidityBootstrappingPool__onSwapInputRequestStruct,
  ...
  queryExit(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): LiquidityBootstrappingPool__queryExitResult {
    let result = super.call(
      "queryExit",
    ...
    return new LiquidityBootstrappingPool__queryExitResult(
      result[0].toBigInt(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_queryExit(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<LiquidityBootstrappingPool__queryExitResult> {
    let result = super.tryCall(
      "queryExit",
      "queryExit(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new LiquidityBootstrappingPool__queryExitResult(
        value[0].toBigInt(),
        value[1].toBigIntArray(),
      ),
    );
  ...
  queryJoin(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): LiquidityBootstrappingPool__queryJoinResult {
    let result = super.call(
      "queryJoin",
    ...
    return new LiquidityBootstrappingPool__queryJoinResult(
      result[0].toBigInt(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_queryJoin(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<LiquidityBootstrappingPool__queryJoinResult> {
    let result = super.tryCall(
      "queryJoin",
      "queryJoin(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new LiquidityBootstrappingPool__queryJoinResult(
        value[0].toBigInt(),
        value[1].toBigIntArray(),
      ),
    );
