...
export class AaveLinearPoolV4Factory extends ethereum.SmartContract {
  ...
  try_getCreationCodeContracts(): ethereum.CallResult<AaveLinearPoolV4Factory__getCreationCodeContractsResult> {
    let result = super.tryCall(
      "getCreationCodeContracts",
      "getCreationCodeContracts():(address,address)",
      [],
  ...
  try_getPauseConfiguration(): ethereum.CallResult<AaveLinearPoolV4Factory__getPauseConfigurationResult> {
    let result = super.tryCall(
      "getPauseConfiguration",
      "getPauseConfiguration():(uint256,uint256)",
      [],
