...
export class MetaStablePool extends ethereum.SmartContract {
  ...
  try_getAmplificationParameter(): ethereum.CallResult<MetaStablePool__getAmplificationParameterResult> {
    let result = super.tryCall(
      "getAmplificationParameter",
      "getAmplificationParameter():(uint256,bool,uint256)",
      [],
  ...
  try_getLastInvariant(): ethereum.CallResult<MetaStablePool__getLastInvariantResult> {
    let result = super.tryCall(
      "getLastInvariant",
      "getLastInvariant():(uint256,uint256)",
      [],
  ...
  try_getOracleMiscData(): ethereum.CallResult<MetaStablePool__getOracleMiscDataResult> {
    let result = super.tryCall(
      "getOracleMiscData",
      "getOracleMiscData():(int256,int256,uint256,uint256,bool)",
      [],
  ...
  try_getPausedState(): ethereum.CallResult<MetaStablePool__getPausedStateResult> {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
      [],
