...
export class SiloLinearPoolCreated extends ethereum.Event {
  get params(): SiloLinearPoolCreated__Params {
    return new SiloLinearPoolCreated__Params(this);
  }
}

export class SiloLinearPoolCreated__Params {
  _event: SiloLinearPoolCreated;

  constructor(event: SiloLinearPoolCreated) {
    this._event = event;
  }
...
export class SiloLinearPoolV2Factory__getCreationCodeContractsResult {
  value0: Address;
  value1: Address;
...
export class SiloLinearPoolV2Factory__getPauseConfigurationResult {
  value0: BigInt;
  value1: BigInt;
...
export class SiloLinearPoolV2Factory extends ethereum.SmartContract {
  static bind(address: Address): SiloLinearPoolV2Factory {
    return new SiloLinearPoolV2Factory("SiloLinearPoolV2Factory", address);
  }
  ...
  getCreationCodeContracts(): SiloLinearPoolV2Factory__getCreationCodeContractsResult {
    let result = super.call(
    ...
    return new SiloLinearPoolV2Factory__getCreationCodeContractsResult(
      result[0].toAddress(),
      result[1].toAddress(),
    );
  }

  try_getCreationCodeContracts(): ethereum.CallResult<SiloLinearPoolV2Factory__getCreationCodeContractsResult> {
    let result = super.tryCall(
      "getCreationCodeContracts",
      "getCreationCodeContracts():(address,address)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new SiloLinearPoolV2Factory__getCreationCodeContractsResult(
        value[0].toAddress(),
        value[1].toAddress(),
      ),
    );
  ...
  getPauseConfiguration(): SiloLinearPoolV2Factory__getPauseConfigurationResult {
    let result = super.call(
    ...
    return new SiloLinearPoolV2Factory__getPauseConfigurationResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_getPauseConfiguration(): ethereum.CallResult<SiloLinearPoolV2Factory__getPauseConfigurationResult> {
    let result = super.tryCall(
      "getPauseConfiguration",
      "getPauseConfiguration():(uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SiloLinearPoolV2Factory__getPauseConfigurationResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
