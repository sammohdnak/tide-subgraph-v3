...
export class TotalSupplyFromChain extends ethereum.Event {
  get params(): TotalSupplyFromChain__Params {
    return new TotalSupplyFromChain__Params(this);
  }
}

export class TotalSupplyFromChain__Params {
  _event: TotalSupplyFromChain;

  constructor(event: TotalSupplyFromChain) {
    this._event = event;
  }
  ...
  get totalSupplyPoint(): TotalSupplyFromChainTotalSupplyPointStruct {
    return changetype<TotalSupplyFromChainTotalSupplyPointStruct>(
      this._event.parameters[1].value.toTuple()
    );
  }
}

export class TotalSupplyFromChainTotalSupplyPointStruct extends ethereum.Tuple {
  get bias(): BigInt {
...
export class UserBalFromChain extends ethereum.Event {
  get params(): UserBalFromChain__Params {
    return new UserBalFromChain__Params(this);
  }
}

export class UserBalFromChain__Params {
  _event: UserBalFromChain;

  constructor(event: UserBalFromChain) {
    this._event = event;
  }
  ...
  get userPoint(): UserBalFromChainUserPointStruct {
    return changetype<UserBalFromChainUserPointStruct>(
      this._event.parameters[2].value.toTuple()
    );
  }

  get totalSupplyPoint(): UserBalFromChainTotalSupplyPointStruct {
    return changetype<UserBalFromChainTotalSupplyPointStruct>(
      this._event.parameters[3].value.toTuple()
    );
  }
}

export class UserBalFromChainUserPointStruct extends ethereum.Tuple {
  get bias(): BigInt {
    return this[0].toBigInt();
  }
...
export class UserBalFromChainTotalSupplyPointStruct extends ethereum.Tuple {
  get bias(): BigInt {
    return this[0].toBigInt();
  }
...
export class omniVotingEscrowChild__getPointValueInput_pointStruct extends ethereum.Tuple {
  get bias(): BigInt {
    return this[0].toBigInt();
  }
...
export class omniVotingEscrowChild__totalSupplyPointResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class omniVotingEscrowChild__userPointsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class omniVotingEscrowChild extends ethereum.SmartContract {
  static bind(address: Address): omniVotingEscrowChild {
    return new omniVotingEscrowChild("omniVotingEscrowChild", address);
  }
  ...
  delegationHook(): Address {
    let result = super.call("delegationHook", "delegationHook():(address)", []);

    return result[0].toAddress();
  }

  try_delegationHook(): ethereum.CallResult<Address> {
  ...
  getPointValue(
    _point: omniVotingEscrowChild__getPointValueInput_pointStruct
  ): BigInt {
    let result = super.call(
      "getPointValue",
      "getPointValue((int128,int128,uint256,uint256)):(uint256)",
      [ethereum.Value.fromTuple(_point)]
    );
  ...
  locked__end(param0: Address): BigInt {
  ...
  try_locked__end(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "locked__end",
  ...
  totalSupplyPoint(): omniVotingEscrowChild__totalSupplyPointResult {
    let result = super.call(
      "totalSupplyPoint",
      "totalSupplyPoint():(int128,int128,uint256,uint256)",
      []
    );

    return new omniVotingEscrowChild__totalSupplyPointResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_totalSupplyPoint(): ethereum.CallResult<
    omniVotingEscrowChild__totalSupplyPointResult
  > {
    let result = super.tryCall(
      "totalSupplyPoint",
      "totalSupplyPoint():(int128,int128,uint256,uint256)",
    ...
    return ethereum.CallResult.fromValue(
      new omniVotingEscrowChild__totalSupplyPointResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  userPoints(param0: Address): omniVotingEscrowChild__userPointsResult {
    let result = super.call(
      "userPoints",
      "userPoints(address):(int128,int128,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    );

    return new omniVotingEscrowChild__userPointsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_userPoints(
    param0: Address
  ): ethereum.CallResult<omniVotingEscrowChild__userPointsResult> {
    let result = super.tryCall(
      "userPoints",
      "userPoints(address):(int128,int128,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new omniVotingEscrowChild__userPointsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
