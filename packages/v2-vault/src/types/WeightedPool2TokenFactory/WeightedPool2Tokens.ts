...
export class WeightedPool2Tokens__getMiscDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class WeightedPool2Tokens__getPastAccumulatorsInputQueriesStruct extends ethereum.Tuple {
  get variable(): i32 {
    return this[0].toI32();
  }
...
export class WeightedPool2Tokens__getPausedStateResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class WeightedPool2Tokens__getSampleResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class WeightedPool2Tokens__getTimeWeightedAverageInputQueriesStruct extends ethereum.Tuple {
  get variable(): i32 {
    return this[0].toI32();
  }
...
export class WeightedPool2Tokens__onExitPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class WeightedPool2Tokens__onJoinPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class WeightedPool2Tokens__onSwapInputRequestStruct extends ethereum.Tuple {
  get kind(): i32 {
    return this[0].toI32();
  }
...
export class WeightedPool2Tokens__queryExitResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class WeightedPool2Tokens__queryJoinResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class WeightedPool2Tokens extends ethereum.SmartContract {
  static bind(address: Address): WeightedPool2Tokens {
    return new WeightedPool2Tokens("WeightedPool2Tokens", address);
  }
  ...
  getMiscData(): WeightedPool2Tokens__getMiscDataResult {
    let result = super.call(
      "getMiscData",
    ...
    return new WeightedPool2Tokens__getMiscDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getMiscData(): ethereum.CallResult<WeightedPool2Tokens__getMiscDataResult> {
    let result = super.tryCall(
      "getMiscData",
      "getMiscData():(int256,int256,uint256,uint256,bool,uint256)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new WeightedPool2Tokens__getMiscDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getPastAccumulators(
    queries: Array<WeightedPool2Tokens__getPastAccumulatorsInputQueriesStruct>,
  ): Array<BigInt> {
    let result = super.call(
      "getPastAccumulators",
  ...
  getPausedState(): WeightedPool2Tokens__getPausedStateResult {
    let result = super.call(
      "getPausedState",
    ...
    return new WeightedPool2Tokens__getPausedStateResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_getPausedState(): ethereum.CallResult<WeightedPool2Tokens__getPausedStateResult> {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new WeightedPool2Tokens__getPausedStateResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),
  ...
  getSample(index: BigInt): WeightedPool2Tokens__getSampleResult {
    let result = super.call(
      "getSample",
    ...
    return new WeightedPool2Tokens__getSampleResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getSample(
    index: BigInt,
  ): ethereum.CallResult<WeightedPool2Tokens__getSampleResult> {
    let result = super.tryCall(
      "getSample",
      "getSample(uint256):(int256,int256,int256,int256,int256,int256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(index)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new WeightedPool2Tokens__getSampleResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getTimeWeightedAverage(
    queries: Array<WeightedPool2Tokens__getTimeWeightedAverageInputQueriesStruct>,
  ): Array<BigInt> {
    let result = super.call(
      "getTimeWeightedAverage",
  ...
  onExitPool(
    ...
    userData: Bytes,
  ): WeightedPool2Tokens__onExitPoolResult {
    let result = super.call(
      "onExitPool",
    ...
    return new WeightedPool2Tokens__onExitPoolResult(
  ...
  try_onExitPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<WeightedPool2Tokens__onExitPoolResult> {
    let result = super.tryCall(
      "onExitPool",
      "onExitPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new WeightedPool2Tokens__onExitPoolResult(
  ...
  onJoinPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): WeightedPool2Tokens__onJoinPoolResult {
    let result = super.call(
      "onJoinPool",
    ...
    return new WeightedPool2Tokens__onJoinPoolResult(
      result[0].toBigIntArray(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_onJoinPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<WeightedPool2Tokens__onJoinPoolResult> {
    let result = super.tryCall(
      "onJoinPool",
      "onJoinPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new WeightedPool2Tokens__onJoinPoolResult(
        value[0].toBigIntArray(),
        value[1].toBigIntArray(),
      ),
    );
  ...
  onSwap(
    request: WeightedPool2Tokens__onSwapInputRequestStruct,
  ...
  queryExit(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): WeightedPool2Tokens__queryExitResult {
    let result = super.call(
      "queryExit",
    ...
    return new WeightedPool2Tokens__queryExitResult(
      result[0].toBigInt(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_queryExit(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<WeightedPool2Tokens__queryExitResult> {
    let result = super.tryCall(
      "queryExit",
      "queryExit(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new WeightedPool2Tokens__queryExitResult(
        value[0].toBigInt(),
        value[1].toBigIntArray(),
      ),
    );
  ...
  queryJoin(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): WeightedPool2Tokens__queryJoinResult {
    let result = super.call(
      "queryJoin",
    ...
    return new WeightedPool2Tokens__queryJoinResult(
      result[0].toBigInt(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_queryJoin(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<WeightedPool2Tokens__queryJoinResult> {
    let result = super.tryCall(
      "queryJoin",
      "queryJoin(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new WeightedPool2Tokens__queryJoinResult(
        value[0].toBigInt(),
        value[1].toBigIntArray(),
      ),
    );
...
export class ConstructorCallParamsStruct extends ethereum.Tuple {
  ...
  get normalizedWeight0(): BigInt {
    return this[5].toBigInt();
  }

  get normalizedWeight1(): BigInt {
