...
export class ComposableStablePoolV2Factory__getCreationCodeContractsResult {
  value0: Address;
  value1: Address;
...
export class ComposableStablePoolV2Factory__getPauseConfigurationResult {
  value0: BigInt;
  value1: BigInt;
...
export class ComposableStablePoolV2Factory extends ethereum.SmartContract {
  static bind(address: Address): ComposableStablePoolV2Factory {
    return new ComposableStablePoolV2Factory(
  ...
  create(
    ...
    exemptFromYieldProtocolFeeFlags: Array<boolean>,
    swapFeePercentage: BigInt,
    owner: Address,
  ): Address {
    let result = super.call(
      "create",
      "create(string,string,address[],uint256,address[],uint256[],bool[],uint256,address):(address)",
      [
        ...
        ethereum.Value.fromBooleanArray(exemptFromYieldProtocolFeeFlags),
  ...
  getCreationCodeContracts(): ComposableStablePoolV2Factory__getCreationCodeContractsResult {
    let result = super.call(
    ...
    return new ComposableStablePoolV2Factory__getCreationCodeContractsResult(
      result[0].toAddress(),
      result[1].toAddress(),
    );
  }

  try_getCreationCodeContracts(): ethereum.CallResult<ComposableStablePoolV2Factory__getCreationCodeContractsResult> {
    let result = super.tryCall(
      "getCreationCodeContracts",
      "getCreationCodeContracts():(address,address)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new ComposableStablePoolV2Factory__getCreationCodeContractsResult(
        value[0].toAddress(),
        value[1].toAddress(),
      ),
    );
  ...
  getPauseConfiguration(): ComposableStablePoolV2Factory__getPauseConfigurationResult {
    let result = super.call(
    ...
    return new ComposableStablePoolV2Factory__getPauseConfigurationResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_getPauseConfiguration(): ethereum.CallResult<ComposableStablePoolV2Factory__getPauseConfigurationResult> {
    let result = super.tryCall(
      "getPauseConfiguration",
      "getPauseConfiguration():(uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new ComposableStablePoolV2Factory__getPauseConfigurationResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
