...
export class CachedProtocolSwapFeePercentageUpdated extends ethereum.Event {
  get params(): CachedProtocolSwapFeePercentageUpdated__Params {
    return new CachedProtocolSwapFeePercentageUpdated__Params(this);
  }
}

export class CachedProtocolSwapFeePercentageUpdated__Params {
  _event: CachedProtocolSwapFeePercentageUpdated;

  constructor(event: CachedProtocolSwapFeePercentageUpdated) {
    this._event = event;
  }
...
export class DueProtocolFeeIncreased extends ethereum.Event {
  get params(): DueProtocolFeeIncreased__Params {
    return new DueProtocolFeeIncreased__Params(this);
  }
}

export class DueProtocolFeeIncreased__Params {
  _event: DueProtocolFeeIncreased;

  constructor(event: DueProtocolFeeIncreased) {
    this._event = event;
  }
...
export class StablePhantomPool__getAmplificationParameterResult {
  value0: BigInt;
  value1: boolean;
  value2: BigInt;
...
export class StablePhantomPool__getLastInvariantResult {
  value0: BigInt;
  value1: BigInt;
  ...
  getLastInvariantAmp(): BigInt {
    return this.value1;
  }
}

export class StablePhantomPool__getPausedStateResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
...
export class StablePhantomPool__getTokenRateCacheResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class StablePhantomPool__onExitPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class StablePhantomPool__onJoinPoolResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class StablePhantomPool__onSwapInputSwapRequestStruct extends ethereum.Tuple {
  get kind(): i32 {
    return this[0].toI32();
  }
...
export class StablePhantomPool__onSwap1InputParam0Struct extends ethereum.Tuple {
  get kind(): i32 {
    return this[0].toI32();
  }
...
export class StablePhantomPool__queryExitResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class StablePhantomPool__queryJoinResult {
  value0: BigInt;
  value1: Array<BigInt>;
...
export class StablePhantomPool extends ethereum.SmartContract {
  static bind(address: Address): StablePhantomPool {
    return new StablePhantomPool("StablePhantomPool", address);
  }
  ...
  getAmplificationParameter(): StablePhantomPool__getAmplificationParameterResult {
    let result = super.call(
    ...
    return new StablePhantomPool__getAmplificationParameterResult(
      result[0].toBigInt(),
      result[1].toBoolean(),
      result[2].toBigInt(),
    );
  ...
  try_getAmplificationParameter(): ethereum.CallResult<StablePhantomPool__getAmplificationParameterResult> {
    let result = super.tryCall(
      "getAmplificationParameter",
      "getAmplificationParameter():(uint256,bool,uint256)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new StablePhantomPool__getAmplificationParameterResult(
        value[0].toBigInt(),
        value[1].toBoolean(),
        value[2].toBigInt(),
      ),
  ...
  getCachedProtocolSwapFeePercentage(): BigInt {
    let result = super.call(
      "getCachedProtocolSwapFeePercentage",
      "getCachedProtocolSwapFeePercentage():(uint256)",
      [],
    );
  ...
  try_getCachedProtocolSwapFeePercentage(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getCachedProtocolSwapFeePercentage",
      "getCachedProtocolSwapFeePercentage():(uint256)",
      [],
  ...
  getDueProtocolFeeBptAmount(): BigInt {
    let result = super.call(
      "getDueProtocolFeeBptAmount",
      "getDueProtocolFeeBptAmount():(uint256)",
      [],
    );
  ...
  try_getDueProtocolFeeBptAmount(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getDueProtocolFeeBptAmount",
      "getDueProtocolFeeBptAmount():(uint256)",
      [],
  ...
  getLastInvariant(): StablePhantomPool__getLastInvariantResult {
    let result = super.call(
      "getLastInvariant",
    ...
    return new StablePhantomPool__getLastInvariantResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_getLastInvariant(): ethereum.CallResult<StablePhantomPool__getLastInvariantResult> {
    let result = super.tryCall(
      "getLastInvariant",
      "getLastInvariant():(uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new StablePhantomPool__getLastInvariantResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
  ...
  getPausedState(): StablePhantomPool__getPausedStateResult {
    let result = super.call(
      "getPausedState",
    ...
    return new StablePhantomPool__getPausedStateResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_getPausedState(): ethereum.CallResult<StablePhantomPool__getPausedStateResult> {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new StablePhantomPool__getPausedStateResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),
  ...
  getScalingFactor(token: Address): BigInt {
    let result = super.call(
      "getScalingFactor",
      "getScalingFactor(address):(uint256)",
  ...
  try_getScalingFactor(token: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getScalingFactor",
      "getScalingFactor(address):(uint256)",
      [ethereum.Value.fromAddress(token)],
  ...
  getTokenRateCache(
    token: Address,
  ): StablePhantomPool__getTokenRateCacheResult {
    let result = super.call(
      "getTokenRateCache",
      "getTokenRateCache(address):(uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(token)],
    );

    return new StablePhantomPool__getTokenRateCacheResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_getTokenRateCache(
    token: Address,
  ): ethereum.CallResult<StablePhantomPool__getTokenRateCacheResult> {
    let result = super.tryCall(
      "getTokenRateCache",
      "getTokenRateCache(address):(uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(token)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new StablePhantomPool__getTokenRateCacheResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),
  ...
  onExitPool(
    ...
    userData: Bytes,
  ): StablePhantomPool__onExitPoolResult {
    let result = super.call(
      "onExitPool",
    ...
    return new StablePhantomPool__onExitPoolResult(
  ...
  try_onExitPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<StablePhantomPool__onExitPoolResult> {
    let result = super.tryCall(
      "onExitPool",
      "onExitPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new StablePhantomPool__onExitPoolResult(
  ...
  onJoinPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): StablePhantomPool__onJoinPoolResult {
    let result = super.call(
      "onJoinPool",
    ...
    return new StablePhantomPool__onJoinPoolResult(
      result[0].toBigIntArray(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_onJoinPool(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<StablePhantomPool__onJoinPoolResult> {
    let result = super.tryCall(
      "onJoinPool",
      "onJoinPool(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256[],uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new StablePhantomPool__onJoinPoolResult(
        value[0].toBigIntArray(),
        value[1].toBigIntArray(),
      ),
    );
  ...
  onSwap(
    swapRequest: StablePhantomPool__onSwapInputSwapRequestStruct,
    balances: Array<BigInt>,
    indexIn: BigInt,
    indexOut: BigInt,
  ): BigInt {
  ...
  queryExit(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): StablePhantomPool__queryExitResult {
    let result = super.call(
      "queryExit",
    ...
    return new StablePhantomPool__queryExitResult(
      result[0].toBigInt(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_queryExit(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<StablePhantomPool__queryExitResult> {
    let result = super.tryCall(
      "queryExit",
      "queryExit(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new StablePhantomPool__queryExitResult(
        value[0].toBigInt(),
        value[1].toBigIntArray(),
      ),
    );
  ...
  queryJoin(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): StablePhantomPool__queryJoinResult {
    let result = super.call(
      "queryJoin",
    ...
    return new StablePhantomPool__queryJoinResult(
      result[0].toBigInt(),
      result[1].toBigIntArray(),
    );
  }
  ...
  try_queryJoin(
    ...
    protocolSwapFeePercentage: BigInt,
    userData: Bytes,
  ): ethereum.CallResult<StablePhantomPool__queryJoinResult> {
    let result = super.tryCall(
      "queryJoin",
      "queryJoin(bytes32,address,address,uint256[],uint256,uint256,bytes):(uint256,uint256[])",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new StablePhantomPool__queryJoinResult(
        value[0].toBigInt(),
        value[1].toBigIntArray(),
      ),
    );
...
export class UpdateCachedProtocolSwapFeePercentageCall extends ethereum.Call {
  get inputs(): UpdateCachedProtocolSwapFeePercentageCall__Inputs {
    return new UpdateCachedProtocolSwapFeePercentageCall__Inputs(this);
  }

  get outputs(): UpdateCachedProtocolSwapFeePercentageCall__Outputs {
    return new UpdateCachedProtocolSwapFeePercentageCall__Outputs(this);
  }
}

export class UpdateCachedProtocolSwapFeePercentageCall__Inputs {
  _call: UpdateCachedProtocolSwapFeePercentageCall;

  constructor(call: UpdateCachedProtocolSwapFeePercentageCall) {
    this._call = call;
  }
}

export class UpdateCachedProtocolSwapFeePercentageCall__Outputs {
  _call: UpdateCachedProtocolSwapFeePercentageCall;
