...
export class AaveLinearPoolV5Factory__getCreationCodeContractsResult {
  value0: Address;
  value1: Address;
...
export class AaveLinearPoolV5Factory__getPauseConfigurationResult {
  value0: BigInt;
  value1: BigInt;
...
export class AaveLinearPoolV5Factory extends ethereum.SmartContract {
  static bind(address: Address): AaveLinearPoolV5Factory {
    return new AaveLinearPoolV5Factory("AaveLinearPoolV5Factory", address);
  }
  ...
  getCreationCodeContracts(): AaveLinearPoolV5Factory__getCreationCodeContractsResult {
    let result = super.call(
    ...
    return new AaveLinearPoolV5Factory__getCreationCodeContractsResult(
      result[0].toAddress(),
      result[1].toAddress(),
    );
  }

  try_getCreationCodeContracts(): ethereum.CallResult<AaveLinearPoolV5Factory__getCreationCodeContractsResult> {
    let result = super.tryCall(
      "getCreationCodeContracts",
      "getCreationCodeContracts():(address,address)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new AaveLinearPoolV5Factory__getCreationCodeContractsResult(
        value[0].toAddress(),
        value[1].toAddress(),
      ),
    );
  ...
  getPauseConfiguration(): AaveLinearPoolV5Factory__getPauseConfigurationResult {
    let result = super.call(
    ...
    return new AaveLinearPoolV5Factory__getPauseConfigurationResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_getPauseConfiguration(): ethereum.CallResult<AaveLinearPoolV5Factory__getPauseConfigurationResult> {
    let result = super.tryCall(
      "getPauseConfiguration",
      "getPauseConfiguration():(uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new AaveLinearPoolV5Factory__getPauseConfigurationResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
